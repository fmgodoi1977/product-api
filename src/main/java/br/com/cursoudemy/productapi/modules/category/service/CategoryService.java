...
public class CategoryService {
    ...
    public SuccessResponse delete(Integer id) {
        ...
        if (productService.existsByCategoryId(id)) {
            throw new ValidationException("You can not delete this category because its already defined by a product.");
        }
        categoryRepository.deleteById(id);
        return SuccessResponse.create("The category wad deleted.");
    }
